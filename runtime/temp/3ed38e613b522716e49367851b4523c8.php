<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/Users/lanlee/Sites/o2o/public/../application/admin/view/bis/index.html";i:1524148599;s:65:"/Users/lanlee/Sites/o2o/application/admin/view/public/header.html";i:1524387529;s:65:"/Users/lanlee/Sites/o2o/application/admin/view/public/footer.html";i:1524389074;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tr class="text-c">
				...
				<td class="td-manage">
					...
					<a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('bis/status',['id'=>$vo['id'],'status'=>-1]); ?>','确认删除吗？')" href="javascript:;" title="删除"><i style="color: #ff67a0" class="Hui-iconfont">删除</i></a></td>
			</tr>
