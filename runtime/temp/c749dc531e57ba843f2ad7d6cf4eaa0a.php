	...
	基本信息：
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
                ...
                <a  id='emailtag' class="btn btn-default radius ml-10 maptag">点击验证邮箱是否存在</a>
                <span>&nbsp;&nbsp;&nbsp;</span>
            <span id="emailmsg" style="color:red; font-size: medium; display: none"></span>
		</div>
		总店信息：
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3 address">
				<input type="text" class="input-text " value="" placeholder=""  name="address">

			</div>
			<a  id='maptag' class="btn btn-default radius ml-10 maptag">标注</a>
                    <span>&nbsp;&nbsp;&nbsp;</span>
                    <span id="tagmsg" style="color:red; font-size: medium; display: none"></span>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text" value="" placeholder=""  name="open_time">
                    ...
                    <span>&nbsp;&nbsp;&nbsp;</span>
                <span id="tagmsg" style="color:#999; font-size: medium;">时间格式示例:05:30-23:30</span>
		</div>
		...
		<div class="row cl">
			...
			<a  id='usertag' class="btn btn-default radius ml-10 maptag">点击验证用户名是否存在</a>
			<span>&nbsp;&nbsp;&nbsp;</span>
			<span id="usermsg" style="color:red; font-size: medium; display: none"></span>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<button  class="btn btn-primary radius" type="submit" id="register"><i class="Hui-iconfont">&#xe632;</i> 申请</button>
				<span>&nbsp;&nbsp;&nbsp;</span>
				<span id="msg" style="color:red; font-size: medium; display: none"></span>
			</div>
...
<script type="text/javascript" src="/o2o/public/static/admin/hui/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="/o2o/public/static/admin/hui/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="/o2o/public/static/admin/hui/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
<!--分配编辑器-->
