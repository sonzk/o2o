<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/Users/lanlee/Sites/o2o/public/../application/admin/view/bis/apply.html";i:1524148543;s:65:"/Users/lanlee/Sites/o2o/application/admin/view/public/header.html";i:1524387529;s:65:"/Users/lanlee/Sites/o2o/application/admin/view/public/footer.html";i:1524389074;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="td-status"><a onclick="o2o_del('<?php echo url('bis/status',['id'=>$vo['id'],'status'=>1]); ?>','确定给通过吗？')" title="点击修改状态"><?php echo status($vo['status']); ?></a></td>
					<td class="td-manage">
						<a style="text-decoration:none" class="ml-5"  href="<?php echo url('bis/detail',['id'=>$vo['id']]); ?>" title="查看" target="_blank"><i class="Hui-iconfont">&#xe6df; 查看</i></a>
						<a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('bis/status',['id'=>$vo['id'],'status'=>2]); ?>','确认不给通过吗？')" href="javascript:;" title="不通过"><i style="color: #ff67a0" class="Hui-iconfont">不通过</i></a></td>
				</tr>
