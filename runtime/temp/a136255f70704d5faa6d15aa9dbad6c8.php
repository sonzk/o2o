<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"/Users/lanlee/Sites/o2o/public/../application/bis/view/deal/index.html";i:1524652284;s:63:"/Users/lanlee/Sites/o2o/application/bis/view/public/header.html";i:1524035969;s:63:"/Users/lanlee/Sites/o2o/application/bis/view/public/footer.html";i:1524388046;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="td-status"><?php echo dealstatus($vo['status']); ?></td>
					<td class="td-manage">
						<a style="text-decoration:none" class="ml-5"  href="<?php echo url('deal/detail',['id'=>$vo['id']]); ?>" title="查看" target="_blank"><i class="Hui-iconfont">查看</i></a>
						<?php if($vo['status'] == 1): ?>
						<a style="text-decoration:none; color: #ff67a0" class="ml-5" onClick="" href="<?php echo url('deal/remove',['id'=>$vo['id'],'status'=>-1]); ?>" title="下架"><i class="Hui-iconfont">下架</i></a>
						<?php elseif($vo['status'] == -1): ?>
						<a style="text-decoration:none; color: #0089ff" class="ml-5" onClick="" href="<?php echo url('deal/remove',['id'=>$vo['id'],'status'=>1]); ?>" title="上架"><i class="Hui-iconfont">上架</i></a>
						<?php endif; ?>
					</td>
				</tr>
