...
CREATE TABLE `o2o_deal`(
  ...
  `coupins_begin_time` INT(11) UNSIGNED NOT NULL DEFAULT 0,
  `coupins_end_time` INT(11) UNSIGNED NOT NULL DEFAULT 0,
  `xpoint` VARCHAR(20) NOT NULL DEFAULT '',
  `ypoint` VARCHAR(20) NOT NULL DEFAULT '',
...
CREATE TABLE `o2o_order`(
  ...
  `total_price` DECIMAL(20,0) NOT NULL DEFAULT '0.00',
  `pay_amount` DECIMAL(20,0) NOT NULL DEFAULT '0.00',
